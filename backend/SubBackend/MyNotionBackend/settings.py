"""
Django settings for MyNotionBackend project.
...
AUTH_USER_MODEL = 'notion_models.User'
...
# SECRET_KEY = "django-insecure-oz#@l55!_tv7awn&6mm)qccxegg41ke9!u-91fxh$qcnib9$)a"
...
INSTALLED_APPS = [
    "graphene_django",
    "notion_models.apps.NotionModelsConfig",
...
WSGI_APPLICATION = "MyNotionBackend.wsgi.application"
...
GRAPHENE = {
    "SCHEMA": "MyNotionBackend.schema.schema"
}
